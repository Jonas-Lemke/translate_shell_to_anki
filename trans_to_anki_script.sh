...
display_usage() {
	...
	echo "		you want to save a flashcard with one of those translations. If"
	echo "		you choose to do so, a string with an formatting for Anki gets" 
	echo "		appended to a txt file that stores all flashcards of your current"
	echo "		session and gTTS is used to generate an mp3 file for the word and" 
	echo "		the chosen translation. After this you will be prompted for the" 
	echo "		next word. When you exit the script the generated audio files are" 
	echo "		copied to the Anki media folder and you can import the txt file"
	echo "		into Anki to get your deck of the vocabulary."
	echo ""
	echo "USAGE" 
